        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-4">
                ...
                <div id="account-id">
                    ...
                    <div class="">
                        <form class="user" method="post" action="<?= base_url('setting/editserverX'); ?>">

                            <div class="form-group">
                                <label for="inputnama">Server Name</label>
                                <input type="text" name="id" id="idn" value="<?= $editserver['id']; ?>" placeholder="Server" hidden>
                                <input type="text" class="form-control input-md" name="server" id="iserv" value="<?= $editserver['server']; ?>" placeholder="Server">
                                <?= form_error('server', '<small class="text-danger pl-3">', '</small>'); ?>
                            </div>

                            <div class="clearfix space20"></div>
                            <div class="buttons-set text-right">
                                <a href="<?= base_url('control/index/0/3'); ?>"><button class="btn btn-black2" type="button">
                                        <span>CLOSE</span>
                                    </button></a>
