		...
		<div class="row">
			...
			<div class="col-md-4 col-sm-4">
				...
				<div id="account-id">
					...
					<form class="changepass" method="post" action="<?= base_url('user/changepass'); ?>/<?= $this->session->userdata('nip'); ?>">
						...
						<div class="buttons-set text-right">
							<a href="<?= base_url('user/profil'); ?>"><button type="button" class="btn btn-black2">
									<span>CLOSE</span>
								</button></a>
